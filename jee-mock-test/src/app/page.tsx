...
export default async function HomePage() {
  ...
  const features = [
    {
      icon: Upload,
      title: "PDF → Prompt → Questions",
      desc: "Upload any textbook PDF. We extract the text and generate a ready-to-paste AI prompt. Get questions JSON back and import instantly.",
    },
    {
      icon: BookOpen,
      title: "In-browser PDF Viewer",
      desc: "View your PDF, drag to crop diagrams, and attach them directly to questions with our built-in PDF.js viewer.",
    },
    {
      icon: Timer,
      title: "Timed Mock Tests",
      desc: "JEE-accurate timer, question palette, mark-for-review — the real exam experience in your browser.",
    },
    {
      icon: BarChart3,
      title: "Score Analytics",
      desc: "Per-subject breakdowns, accuracy rates, time analysis. Understand exactly where you stand.",
    },
    {
      icon: Share2,
      title: "Share Tests",
      desc: "Make any test public with a slug-based URL. Share with friends or your entire coaching batch.",
    },
    {
      icon: Zap,
      title: "Full CRUD",
      desc: "Create, edit, duplicate and delete tests. Manage your entire question bank from one dashboard.",
    },
  ];
    ...
    <div className="min-h-screen bg-ink-50 bg-grid-ink">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-24 pb-20">
        <div className="stagger-children">
          <div className="badge text-amber-600 border-amber-600 mb-6">
            Free & Open Source
          </div>
          <h1 className="font-display text-6xl md:text-8xl font-black text-ink-900 leading-none mb-6">
            Mock Tests,<br />
            <span className="text-amber-500">Forged</span> from<br />
            Your Notes.
          </h1>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/auth/sign-up" className="btn-neo-amber px-6 py-3 text-base">
              Start Forging →
            </Link>
            <Link href="/auth/sign-in" className="btn-neo-outline px-6 py-3 text-base">
              Sign In
            </Link>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-0 border-2 border-ink-900">
          {features.map((f, i) => {
            ...
            return (
              <div
                key={i}
                className={`p-8 bg-white hover:bg-amber-50 transition-colors duration-200
                  ${!isLastInRow ? "border-r-2 border-ink-900" : ""}
      ...
      <section className="border-t-2 border-ink-900 bg-ink-900 py-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="font-display text-5xl font-black text-ink-50 mb-4">
            Ready to start?
          </h2>
          <p className="font-body text-ink-300 mb-8 text-lg">
            No credit card. No subscriptions. Just better mock tests.
          </p>
